...
export const STRINGS_DE: Strings = {
	...
	cardsLayout: {
		title: 'Layout',
		hint: 'Titelbild und Kartengröße für das Galerie-Raster.',
		cover: 'Titelbild',
		coverNone: 'Keins',
		coverProperty: 'Eigenschaft',
	...
	displayField: {
		...
		formulaHelp: 'Formelhilfe',
		formulaHelpFunctions: 'Funktionen',
		formulaHelpSyntax: 'Syntax',
		formulaHelpSyntaxItems: [
			'{name} — Eigenschaft oder anderes Feld',
			'+ − * / Zahlen; + verbindet auch Text und addiert Tage zu Datumswerten',
			'& verbindet Text',
			'== != > < >= <=',
			'"Text" oder \'Text\'',
			'TRUE / FALSE',
			'Datum: JJJJ-MM-TT oder JJJJ-MM-TTTHH:mm',
		],
		formulaFns: {
			MIN: 'Kleinste Zahl oder frühestes Datum; überspringt ERR.',
			MAX: 'Größte Zahl oder spätestes Datum; überspringt ERR.',
			IF: 'Gibt then zurück, wenn cond wahr ist, sonst else.',
			AND: 'Wahr, wenn jedes Argument wahr ist.',
			OR: 'Wahr, wenn irgendein Argument wahr ist.',
			CONCAT: 'Verbindet Argumente als Text.',
			LEFT: 'Die ersten n Zeichen.',
			RIGHT: 'Die letzten n Zeichen.',
			MID: 'Teilzeichenkette ab 1-basiertem Start; Länge optional.',
			LOWER: 'Text in Kleinbuchstaben.',
			UPPER: 'Text in Großbuchstaben.',
			SEARCH: '1-basierte Position von needle, oder 0 wenn nicht gefunden.',
		},
	},
	cardsInfo: {
		title: 'Karteninfo',
