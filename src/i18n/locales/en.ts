export const STRINGS_EN = {
	...
	cardsLayout: {
		title: 'Layout',
		hint: 'Cover image and card size for the gallery grid.',
		cover: 'Cover',
		coverNone: 'None',
		coverProperty: 'Property',
		coverFirstEmbed: 'First image embed',
		coverPropertyName: 'Cover property',
		coverPropertyPlaceholder: 'cover',
		coverDisplay: 'Image display',
		coverDisplayFit: 'Fit whole image',
		coverDisplayUniform: 'Uniform size (crop)',
		coverHeightRatio: 'Height ratio',
		coverHeightRatioHint: 'Cover height as a fraction of card width (e.g. 0.8).',
		cardSize: 'Card size',
		sizeS: 'Small',
		sizeM: 'Medium',
		sizeL: 'Large',
	...
	displayField: {
		...
		formulaHelp: 'Formula help',
		formulaHelpFunctions: 'Functions',
		formulaHelpSyntax: 'Syntax',
		formulaHelpSyntaxItems: [
			'{name} — property or another field',
			'+ − * / numbers; + also joins text and adds days to dates',
			'& concatenates text',
			'== != > < >= <=',
			'"text" or \'text\'',
			'TRUE / FALSE',
		...
		formulaFns: {
			MIN: 'Smallest number or earliest date; skips ERR.',
			MAX: 'Largest number or latest date; skips ERR.',
			IF: 'Returns then if cond is true, otherwise else.',
			AND: 'True if every argument is true.',
			OR: 'True if any argument is true.',
			CONCAT: 'Joins arguments as text.',
			LEFT: 'First n characters.',
			RIGHT: 'Last n characters.',
			MID: 'Substring from 1-based start; length is optional.',
			LOWER: 'Lowercase text.',
			UPPER: 'Uppercase text.',
			SEARCH: '1-based position of needle, or 0 if not found.',
		},
	},
	cardsInfo: {
		title: 'Cards info',
